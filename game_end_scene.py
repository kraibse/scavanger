...
class GameOverScene(Scene):
    def __init__(self, screen, scene_manager):
        ...
        self.main_menu_button = Button(screen,SCREEN_W//2,SCREEN_H//2,text='Main Menu',action='set_main_menu')
...
class GameWonScene(Scene):
    def __init__(self, screen, scene_manager):
        ...
        self.score_text_box = TextBox(screen,SCREEN_W//2-50,SCREEN_H*0.32,'Score',)
        self.score_text_value = TextBox(screen,SCREEN_W//2,SCREEN_H*0.4,'',dynamic_text='mined_resources')
        self.main_menu_button = Button(screen,SCREEN_W//2,SCREEN_H//2,text='Main Menu',action='set_main_menu')
