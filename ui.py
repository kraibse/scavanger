...
class UI:
    def __init__(self,screen) -> None:
        ...
        self.main_menu_button = Button(self.screen,SCREEN_W-30,SCREEN_H*0.05,image_main_menu,image_main_menu,scale=1.5,action='set_main_menu')
        ...
        self.level_box = TextBox(self.screen,SCREEN_W*0.02,SCREEN_H-SCREEN_H*0.05,'',dynamic_text='current_scene')
